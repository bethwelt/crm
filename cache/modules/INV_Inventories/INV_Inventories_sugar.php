 ...
 */
class INV_Inventories_sugar extends Basic {
	var $new_schema = true;
	var $module_dir = 'INV_Inventories';
	var $object_name = 'INV_Inventories';
	var $table_name = 'inv_inventories';
	var $importable = true;
    var $lineItems = true;
     ...
     */
    function INV_Inventories_sugar(){
