<?php /* Smarty version 2.6.29, created on 2018-06-05 12:24:24
         compiled from cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl', 46, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl', 128, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl', 248, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/cost_Costs/SearchForm_popup_query_form.tpl', 139, false),)), $this); ?>
...
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['date_closed_advanced']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['date_closed_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex=''    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['date_closed_advanced']['name']; ?>
...
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['date_closed_advanced']['name']; ?>
",
...
",
button : "<?php echo $this->_tpl_vars['fields']['date_closed_advanced']['name']; ?>
_trigger",
singleClick : true,
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_modified_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_created_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_assigned_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_currency_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Currencies"],"group":"or","field_list":["name","id"],"populate_list":["currency_name_advanced","currency_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_f_supplier_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Bt_Bank"],"group":"or","field_list":["name","id"],"populate_list":["f_supplier_c_advanced","bt_bank_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_delivery_supp_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Sup_Supplier"],"group":"or","field_list":["name","id"],"populate_list":["delivery_supp_c_advanced","sup_supplier_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_partnername_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_partnername_c_advanced","account_id_c_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id_c"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_deliverysupplier_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_deliverysupplier_c_advanced","account_id1_c_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id1_c"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_bank_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_bank_c_advanced","account_id2_c_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id2_c"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_freightsupplier_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_freightsupplier_c_advanced","account_id3_c_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id3_c"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_opportunity_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Opportunities"],"group":"or","field_list":["name","id"],"populate_list":["opportunity_c_advanced","opportunity_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_client_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_client_c_advanced","account_id4_c_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id4_c"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_customcost_c_advanced\']={"form":"popup_query_form","method":"query","modules":["CU_Customs"],"group":"or","field_list":["name","id"],"populate_list":["customcost_c_advanced","cu_customs_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_forwarding_c_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_forwarding_c_advanced","account_id5_c_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id5_c"],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>