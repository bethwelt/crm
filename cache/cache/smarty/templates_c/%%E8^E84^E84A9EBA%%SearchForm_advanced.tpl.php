...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'CO_Costs'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='date_closed_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_CLOSED','module' => 'CO_Costs'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='next_step_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NEXT_STEP','module' => 'CO_Costs'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='lead_source_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'CO_Costs'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='sales_stage_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALES_STAGE','module' => 'CO_Costs'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'CO_Costs'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
