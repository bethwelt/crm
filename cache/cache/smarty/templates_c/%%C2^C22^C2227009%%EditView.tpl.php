<?php /* Smarty version 2.6.29, created on 2018-06-05 16:56:25
         compiled from cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 38, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 141, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 243, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 44, false),array('function', 'counter', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 56, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 116, false),array('function', 'sugar_number_format', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 375, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/INV_Inventories/EditView.tpl', 657, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=INV_Inventories'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
&module_name=INV_Inventories", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="button" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALE_INFORMATION','module' => 'INV_Inventories'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'INV_Inventories'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='inv_inventories_type_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<select name="<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['inv_inventories_type']['value'] ) && $this->_tpl_vars['fields']['inv_inventories_type']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['inv_inventories_type']['options'],'selected' => $this->_tpl_vars['fields']['inv_inventories_type']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['inv_inventories_type']['options'],'selected' => $this->_tpl_vars['fields']['inv_inventories_type']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['inv_inventories_type']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['inv_inventories_type']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['inv_inventories_type']['name']; ?>
');
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AMOUNT','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_CLOSED','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='sales_stage_label' width='12.5%' data-total-columns="1" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALES_STAGE','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<td valign="top" id='next_step_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NEXT_STEP','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROBABILITY','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'INV_Inventories'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'inv_inventories_type\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'lead_source\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'amount\', \'currency\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_AMOUNT','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'amount_usdollar\', \'currency\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_AMOUNT_USDOLLAR','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'currency_id\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'currency_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY_NAME','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'currency_symbol\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY_SYMBOL','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'date_closed\', \'date\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_CLOSED','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'next_step\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NEXT_STEP','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'sales_stage\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALES_STAGE','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidateRange(\'EditView\', \'probability\', \'int\', false, \''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROBABILITY','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\', 0, 100);
addToValidate(\'EditView\', \'aos_products_id1_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PNAME_AOS_PRODUCTS_ID','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'aos_product_categories_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATEGORY_AOS_PRODUCT_CATEGORIES_ID','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'category_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATEGORY','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'condi_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONDI','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'fp_event_locations_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LOCATION_FP_EVENT_LOCATIONS_ID','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'location_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LOCATION','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'model_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODEL','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'partnunber_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PARTNUNBER','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'pname_c\', \'relate\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PNAME','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'status_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'type_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'INV_Inventories','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'INV_Inventories','for_js' => true), $this);?>
