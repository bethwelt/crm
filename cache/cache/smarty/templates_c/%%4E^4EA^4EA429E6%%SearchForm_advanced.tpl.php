<?php /* Smarty version 2.6.29, created on 2018-06-05 16:56:19
         compiled from cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl', 46, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl', 135, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl', 142, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/INV_Inventories/SearchForm_advanced.tpl', 150, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='amount_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AMOUNT','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='date_closed_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_CLOSED','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='probability_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROBABILITY','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='next_step_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NEXT_STEP','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='lead_source_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEAD_SOURCE','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='sales_stage_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALES_STAGE','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'INV_Inventories'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
