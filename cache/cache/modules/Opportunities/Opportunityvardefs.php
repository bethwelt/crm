<?php 
 $GLOBALS["dictionary"]["Opportunity"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Gross Margin Amount',
      'required' => true,
      'source' => 'custom_fields',
      'name' => 'gmamount_c',
      'vname' => 'LBL_GMAMOUNT',
    ...
    array (
      'inline_edit' => '1',
      'options' => 'numeric_range_search_dom',
      'labelValue' => 'Gross Margin percentage',
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'account_id1_c',
      'vname' => 'LBL_CLIENT_NAME_ACCOUNT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'account_id2_c',
      'vname' => 'LBL_CLIENTNAME_ACCOUNT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'contact_id_c',
      'vname' => 'LBL_SALESPERSON_CONTACT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiessalesperson_c',
      'custom_module' => 'Opportunities',
    ),
    'datenext_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Date Next',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'datenext_c',
      'vname' => 'LBL_DATENEXT',
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'co_costs_id_c',
      'vname' => 'LBL_APPROACHFEES_CO_COSTS_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Opportunitiesco_costs_id_c',
      'custom_module' => 'Opportunities',
    ),
    'approachfees_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Approach Fees',
      'required' => false,
      'source' => 'non-db',
      'name' => 'approachfees_c',
      'vname' => 'LBL_APPROACHFEES ',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'co_costs_id_c',
      'ext2' => 'CO_Costs',
      'module' => 'CO_Costs',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiesapproachfees_c',
      'custom_module' => 'Opportunities',
    ),
    'co_costs_id1_c' => 
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'co_costs_id1_c',
      'vname' => 'LBL_PARTNERCOST_CO_COSTS_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Opportunitiesco_costs_id1_c',
      'custom_module' => 'Opportunities',
    ),
    'partnercost_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Partner Cost',
      'required' => false,
      'source' => 'non-db',
      'name' => 'partnercost_c',
      'vname' => 'LBL_PARTNERCOST',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'co_costs_id1_c',
      'ext2' => 'CO_Costs',
      'module' => 'CO_Costs',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiespartnercost_c',
      'custom_module' => 'Opportunities',
    ),
    'datenex_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Next Date',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'datenex_c',
      'vname' => 'LBL_DATENEX',
