...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='CU_Customs'}</label>
                    </td>
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='CU_Customs'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
