...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='CO_Costs'}</label>
                    </td>
...
<input type='text' name='{$fields.amount_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='date_closed_advanced'>{sugar_translate label='LBL_DATE_CLOSED' module='CO_Costs'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.probability_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='next_step_advanced'>{sugar_translate label='LBL_NEXT_STEP' module='CO_Costs'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.next_step_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='lead_source_advanced'>{sugar_translate label='LBL_LEAD_SOURCE' module='CO_Costs'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
{html_options id='lead_source_advanced' name='lead_source_advanced[]' options=$fields.lead_source_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.lead_source_advanced.value}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='sales_stage_advanced'>{sugar_translate label='LBL_SALES_STAGE' module='CO_Costs'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
{html_options id='sales_stage_advanced' name='sales_stage_advanced[]' options=$fields.sales_stage_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.sales_stage_advanced.value}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='CO_Costs'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
