...
<input type="text" name="{$fields.partnercost_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.partnercost_c.name}" size="" value="{$fields.partnercost_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.partnercost_c.id_name}" 
id="{$fields.partnercost_c.id_name}" 
value="{$fields.co_costs_id1_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.partnercost_c.name}" id="btn_{$fields.partnercost_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.partnercost_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"co_costs_id1_c","name":"partnercost_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.partnercost_c.name}" id="btn_clr_{$fields.partnercost_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.partnercost_c.name}', '{$fields.partnercost_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.partnercost_c.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
<input type="text" name="{$fields.clientname_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.clientname_c.name}" size="" value="{$fields.clientname_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.clientname_c.id_name}" 
id="{$fields.clientname_c.id_name}" 
value="{$fields.account_id2_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.clientname_c.name}" id="btn_{$fields.clientname_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
"{$fields.clientname_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id2_c","name":"clientname_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.clientname_c.name}" id="btn_clr_{$fields.clientname_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.clientname_c.name}', '{$fields.clientname_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.clientname_c.name}']) != 'undefined'",
		enableQS
);
</script>
...
<input type="text" name="{$fields.approachfees_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.approachfees_c.name}" size="" value="{$fields.approachfees_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.approachfees_c.id_name}" 
id="{$fields.approachfees_c.id_name}" 
value="{$fields.co_costs_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.approachfees_c.name}" id="btn_{$fields.approachfees_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.approachfees_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"co_costs_id_c","name":"approachfees_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.approachfees_c.name}" id="btn_clr_{$fields.approachfees_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.approachfees_c.name}', '{$fields.approachfees_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.approachfees_c.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
{if strlen($fields.negamount_c.value) <= 0}
{assign var="value" value=$fields.negamount_c.default_value }
{else}
{assign var="value" value=$fields.negamount_c.value }
{/if}  
<input type='text' name='{$fields.negamount_c.name}' 
id='{$fields.negamount_c.name}' size='30' maxlength='26' value='{sugar_number_format var=$value}' title='' tabindex='0'
>
...
{if strlen($fields.gmamount_c.value) <= 0}
{assign var="value" value=$fields.gmamount_c.default_value }
{else}
{assign var="value" value=$fields.gmamount_c.value }
{/if}  
<input type='text' name='{$fields.gmamount_c.name}' 
id='{$fields.gmamount_c.name}' size='30' maxlength='26' value='{sugar_number_format var=$value}' title='' tabindex='0'
>
</tr>
{/capture}
{if $fieldsUsed > 0 }
...
{assign var="value" value=$fields.gmperc_c.default_value }
{else}
{assign var="value" value=$fields.gmperc_c.value }
{/if}  
<input type='text' name='{$fields.gmperc_c.name}' 
id='{$fields.gmperc_c.name}' size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
addToValidate('EditView', 'client_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CLIENT' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'country_c', 'enum', true,'{/literal}{sugar_translate label='LBL_COUNTRY' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'gmamount_c', 'currency', true,'{/literal}{sugar_translate label='LBL_GMAMOUNT' module='Opportunities' for_js=true}{literal}' );
addToValidateRange('EditView', 'gmperc_c', 'int', true, '{/literal}{sugar_translate label='LBL_GMPERC' module='Opportunities' for_js=true}{literal}', 0, 100);
addToValidate('EditView', 'negamount_c', 'currency', true,'{/literal}{sugar_translate label='LBL_NEGAMOUNT' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'account_id1_c', 'id', false,'{/literal}{sugar_translate label='LBL_CLIENT_NAME_ACCOUNT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'client_name_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CLIENT_NAME' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'account_id2_c', 'id', false,'{/literal}{sugar_translate label='LBL_CLIENTNAME_ACCOUNT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'clientname_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CLIENTNAME' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'lead_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_LEAD_LEAD_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'lead_c', 'relate', false,'{/literal}{sugar_translate label='LBL_LEAD' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'type_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TYPE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_SALESPERSON_CONTACT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'salesperson_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SALESPERSON' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'datenext_c_date', 'date', false,'Date Next' );
addToValidate('EditView', 'co_costs_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_APPROACHFEES_CO_COSTS_ID' module='Opportunities' for_js=true}{literal}' );
